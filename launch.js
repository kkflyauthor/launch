...
$(document).ready(function(){
                    ...
                    setCookie("86", "http://tool.lu/timestamp/");
                    setCookie("87", "http://weibo.com");
                    setCookie("71", "http://github.com");
                    setCookie("70", "http://www.fdzh.org");
                    setCookie("67", "https://coding.net");
                    setCookie("66", "http://www.bilibili.com");
                    setCookie("72", "https://news.ycombinator.com");
                    ...
                    _search.focus(function(){
                        _search.attr('placeholder','输入关键字搜索、输入网址直达、输入“设置”进入设置');//I don`t konw why space work on here not &emsp; ...
                    });
                    _search.blur(function(){
                        _search.attr('placeholder','按对应的键盘导航进行冲浪，或按 Tab 键切换至搜索');//I don`t konw why space work on here not &emsp; ...
                    });
                    ...
                    $("#settingImg").click(function(){
                        ...
                        var u = prompt("请输入按键 ['"+_parent.siblings('li').text()+"'] 对应的网址：\n(不以 http://、ftp:// 等开头的网址将自动填充 http://)", getCookie(key) || "www.example.com");
                    ...
                    if (_search.val() == 'setting' || _search.val() == '设置'){
                        ...
                        _setting.html("<form id='settingDetail' style='display:none;margin:26px 60px;'><input type='checkbox' name='newWindow' value='t'/><p>新窗口打开网页（部分浏览器可能会阻止此行为）</p><br/><p>选择搜索引擎：&emsp;&emsp;&emsp;</p><input type='radio' name='searchEngine' value='Google' /><p>Google&emsp;&emsp;&emsp;</p><input type='radio' name='searchEngine' value='Bing' /><p>Bing&emsp;&emsp;&emsp;</p><input type='radio' name='searchEngine' value='Baidu' /><p>Baidu</p><br/><p>其他搜索引擎：</p><input type='text' name='searchEngineURL' placeholder='eg:g.openibm.com（不使用则留空）' style='width:220px;'/><p>&emsp;post&ensp;key：</p><input type='text' name='searchEnginePOST' placeholder='eg:q' style='width:36px;' /><p>&emsp;https等请自带</p><br/><p>背景图片连接：</p><input type='text' name='backgroundURL' placeholder='&emsp;支持所有您能正常访问的图库，不使用则留空' style='width:280px;' /><p>&emsp;同步 bing 背景：t.cn/R2ZvEBX</p><br/><p style='margin-top:20px;'><span id='CANCEL'>取消</span><span id='OK'>保存</span></p></form>");
